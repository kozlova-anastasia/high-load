...
| :--- | :--- | :--- | :--- | :--- | :--- |
| PostgreSQL | 84 700 | 285 | 512 Гб | - | Лайки/подписки, просмотр контента: 83 531 RPS <br>Публикация постов: 492.71 RPS <br>Публикация сторис: 653.13 RPS <br>Аuth: 38 RPS (7 заходов в день, TTL 30 дней, Пик RPS по всем пользователям 8 021) |
| Redis | 211 000 | 523 | 26 Тб | - | Лайки/подписки + просмотр контента: 199 477 RPS <br>Публикация постов: 492.71 RPS <br>Публикация сторис: 653.13 RPS <br>Auth: 10 427 RPS (8 021 RPS, 30% refresh) |
...
| RustFS | 181 Гбит/с | 88 | 256 Гб | 181 Гбит | см. 4.2 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| PostgreSQL | Bare | 48 cpu / 256 ram / 4 × 1920 NVMe | 6 | 45 000 ₽ | 270 000 ₽ |
| Redis | Bare | 64 cpu / 4096 ram / 4 × 3840 NVMe | 8 | 120 000 ₽ | 960 000 ₽ |
| Kafka | Bare | 32 cpu / 128 ram / 4 × 1920 NVMe | 5 | 35 000 ₽ | 175 000 ₽ |
| RustFS | Bare | 32 cpu / 128 ram / 12 × 16 TB HDD | 3 | 120 000 ₽ | 360 000 ₽ |
| Backend | VPS | 32 cpu / 8 ram / 100 GB NVMe | 20 | 25 000 ₽ | 500 000 ₽ |
| Web | VPS | 16 cpu / 16 ram / 100 GB NVMe | 6 | 12 000 ₽ | 72 000 ₽ |
| NGINX | VPS | 32 cpu / 16 ram / 50 GB NVMe | 27 | 25 000 ₽ | 675 000 ₽ |
| K8s | VPS | 8 cpu / 16 ram / 100 GB NVMe | 3 | 7 500 ₽ | 22 500 ₽ |

## 11.3. Kubernetes

| Сервис | Поды | CPU req/lim | RAM req/lim |
| :--- | :--- | :--- | :--- |
| Backend | 20 | 16/32 | 4/8 Гб |
| Web | 6 | 16/32 | 8/16 Гб |
| NGINX | 27 | 16/32 | 3/6 Гб |
